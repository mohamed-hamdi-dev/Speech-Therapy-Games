            ...
            <label className="block">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="********"
                  className="w-full rounded-[1.6rem] border border-slate-200 bg-slate-50 pr-12 pl-14 py-4 text-lg outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-100"
                />
              </div>
            </label>
